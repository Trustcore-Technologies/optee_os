...
//Trustcore Technologies. SMC handler.
#define TRUSTCORE_SMC_FUNCID_CALL_WITH_REGD_ARG	U(0x100)
#define TRUSTCORE_SMC_CALL_WITH_REGD_ARG \
	OPTEE_SMC_STD_CALL_VAL(TRUSTCORE_SMC_FUNCID_CALL_WITH_REGD_ARG)

#define CHECK_IF_TRUSTCORE_SMC(a) ((a & (~0xFFu)) == TRUSTCORE_SMC_CALL_WITH_REGD_ARG)

#define EXTRACT_TRUSTCORE_SUBID_FROM_SMCID(a) (a & 0xFF)
